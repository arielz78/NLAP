...
fixture goes stale:  python -m models.ranking.make_fixture [--out PATH] [--seed 7]
...
def main(argv=None):
    ...
    ap.add_argument("--out", default=os.path.join("models", "ranking", "fixtures",
    ...
    snapshot = {
        ...
        "note": "FIXTURE — synthetic data generated by models.ranking.make_fixture",
