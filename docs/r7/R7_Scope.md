...
- **⛔ Step 1c remains blocking.** Round 1 is complete (14 / 15 / 9) but not reconciled or applied. The remaining contract question is how the 14 ELIGIBLE-but-unsectioned rows are authored, marked and treated in §85 evaluation; click-only and unclear rows require selective adjudication or explicit withholding. Tracked under #121.
