...
⚠️ **NEW AND UNRESOLVED (2026-08-02) — performance language appears on both sides of the gate question. OPEN OBSERVATION, NOT A SETTLED READING.** Five of Step 1c's 15 permanent rejections give the reason *"doesn't get clicks"*, which answers the **ranking** question rather than the eligibility one. The same language appears in the Step 4b sitting at a comparable rate (3/30 vs 5/38) — but there only on **KEEP** (*"it drives clicks"*, *"one of the best performing events"*), and the 4b sheet carried guardrails the 1c form lacked.

⚠️ **Do not treat this as established.** An earlier draft of this line concluded *"the editor has one decision variable, not two — the gate/ranker split is our architecture, not his."* **That is an overclaim from eight comments across two sittings** and is withdrawn as a finding (Codex review, 2026-08-02). It remains a live hypothesis. **Two readings are still open and both are consistent with the evidence:** (a) the editor genuinely holds one performance variable and no prompt wording will make him answer inside our split; (b) the 1c instrument was materially worse — it omitted both Step 4b repairs — and part of the leak is instrument, not editor. These are not exclusive.

The decidable form of the question is measurable rather than arguable: is low expected performance a property of the **event** (stable across every appearance → legitimately gate-negative) or of the **week** (→ ranker)? Beehiiv history can answer it for event types with published history. **The prior question, which comes first, is how much gate/ranker fuzziness is acceptable by design** — that is an architecture decision and has not been made. **Until it is, the five rows have no defensible target and Step 1c cannot be reconciled.**
