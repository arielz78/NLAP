...
1. **Freeze the live pull** — issue 2026-08-13, events Aug 14–23. Verify the committed R1 Stage 0 rules against the running n8n workflow, then apply them read-only to the frozen snapshot. **Stage 0 already exists in `workflows/NLAP R1.json`** (Eventbrite `.ca`/`.com` allowlist, geographic filtering) — verify and apply, do not rebuild.
